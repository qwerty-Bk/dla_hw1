...
class CTCCharTextEncoder(CharTextEncoder):
    ...
    def __init__(self, alphabet: List[str], lang: str = 'en'):
    ...
    def prepare_kenlm(self):
        ...
        if self.lang == 'en':
            ...
            print(f"Beam search not supported for the language: {self.lang}")
            return None, None
    ...
    @classmethod
    def get_russian_alphabet(cls):
        return cls(alphabet=list(map(chr, range(ord('а'), ord('я') + 1))) + ['ё', ' '], lang='ru')
